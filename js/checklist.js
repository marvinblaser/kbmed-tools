    ...
    validation: {
      ...
      tasks: [
        ...
        },
        {
          ...
          text: "Ajouter les images annotées (P1, T1)",
        },
        {
          id: "validation-task-19",
          text: "Afficher le rapport (table des matières, graphique, charges) (Ajout de session > Rapport > Rapport fuite d'air)",
        },
        {
          id: "validation-task-20",
          text: "Enregistrer le rapport du test de vide (GRAD < 00,13 bar/min)",
        },
        {
